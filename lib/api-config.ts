...
export const apiEndpoints = {
  ...
  heartbeat: `${API_BASE_URL}/api/realtime.php?action=heartbeat`,
  onlineStatus: `${API_BASE_URL}/api/realtime.php?action=online-status`,
  newMessages: `${API_BASE_URL}/api/realtime.php?action=new-messages`,
  realtimeSSE: `${API_BASE_URL}/api/realtime.php?action=sse`,
